...
def change_emotion(objective, emotion):
    ...
    elif emotion == "triste" and (objective.current_emotion == "neutrale" or objective.current_emotion != "neutrale"):
    ...
    elif emotion == "arrabbiato" and objective.current_emotion == "neutrale" and (objective.current_emotion == "neutrale" or objective.current_emotion != "neutrale"):
    ...
    elif emotion == "gioioso" and objective.current_emotion == "neutrale" and (objective.current_emotion == "neutrale" or objective.current_emotion != "neutrale"):
        objective.current_emotion = "gioioso"
    # FELICITA' LIVELLO 1 + LIVELLO 1 CON MAX >=2 o DA NEUTRALE A LIVELLO 2
    elif emotion == "gioioso" and objective.current_emotion == "gioioso" and objective.emotional_levels["Rabbia"] >= 2 or emotion == "felice" and (objective.current_emotion == "neutrale" or objective.current_emotion != "neutrale") and objective.emotional_levels["Rabbia"] >= 2:
        objective.current_emotion = "felice"
    # FELICITA' LIVELLO 1 + LIVELLO 2 CON MAX >=3 o DA NEUTRALE A LIVELLO 3
    elif emotion == "gioioso" and objective.current_emotion == "felice" and objective.emotional_levels["Rabbia"] >= 3 or emotion == "euforico" and (objective.current_emotion == "neutrale" or objective.current_emotion != "neutrale") and objective.emotional_levels["Rabbia"] >= 3:
