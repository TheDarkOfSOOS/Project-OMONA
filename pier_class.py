    ...
    def do_something(self, boss):
        ...
        if self.sel["has_cursor_on"]=="Sbracciata":
            ...
            if self.is_doing_animation:
                ...
                self.remove_mna(MNA_CONSUMPTION, len(self.sbracciata_animation)/0.80, round(MNA_CONSUMPTION/(len(self.sbracciata_animation)/0.80),2))
        ...
        if self.sel["has_cursor_on"]=="Richiesta d'aiuto":
            if self.is_doing_animation:
                ...
                self.remove_mna(MNA_CONSUMPTION, len(self.sbracciata_animation)/0.65, round(MNA_CONSUMPTION/(len(self.sbracciata_animation)/0.65),2))
