...
def change_emotion(objective, emotion):
    ...
    elif emotion == "triste" and objective.current_emotion == "neutrale":
        objective.current_emotion = "triste"
    # TRISTEZZA LIVELLO 1 + LIVELLO 1 CON MAX >=2 o DA NEUTRALE A LIVELLO 2
    elif emotion == "triste" and objective.current_emotion == "triste" and objective.emotional_levels["Tristezza"] >= 2 or emotion == "depresso" and objective.current_emotion == "neutrale" and objective.emotional_levels["Tristezza"] >= 2:
        objective.current_emotion = "depresso"
    # TRISTEZZA LIVELLO 1 + LIVELLO 2 CON MAX >=3 o DA NEUTRALE A LIVELLO 3
    elif emotion == "triste" and objective.current_emotion == "depresso" and objective.emotional_levels["Tristezza"] >= 3 or emotion == "disperato" and objective.current_emotion == "neutrale" and objective.emotional_levels["Tristezza"] >= 3:
    ...
    elif emotion == "arrabbiato" and objective.current_emotion == "neutrale":
        objective.current_emotion = "arrabbiato"
    # RABBIA LIVELLO 1 + LIVELLO 1 CON MAX >=2 o DA NEUTRALE A LIVELLO 2
    elif emotion == "arrabbiato" and objective.current_emotion == "arrabbiato" and objective.emotional_levels["Rabbia"] >= 2 or emotion == "iracondo" and objective.current_emotion == "neutrale" and objective.emotional_levels["Rabbia"] >= 2:
        objective.current_emotion = "iracondo"
    # RABBIA LIVELLO 1 + LIVELLO 2 CON MAX >=3 o DA NEUTRALE A LIVELLO 3
    elif emotion == "arrabbiato" and objective.current_emotion == "iracondo" and objective.emotional_levels["Rabbia"] >= 3 or emotion == "furioso" and objective.current_emotion == "neutrale" and objective.emotional_levels["Rabbia"] >= 3:
    ...
    elif emotion == "gioioso" and objective.current_emotion == "gioioso" and objective.emotional_levels["Rabbia"] >= 2 or emotion == "felice" and objective.current_emotion == "neutrale" and objective.emotional_levels["Rabbia"] >= 2:
        objective.current_emotion = "felice"
    # FELICITA' LIVELLO 1 + LIVELLO 2 CON MAX >=3 o DA NEUTRALE A LIVELLO 3
    elif emotion == "gioioso" and objective.current_emotion == "felice" and objective.emotional_levels["Rabbia"] >= 3 or emotion == "euforico" and objective.current_emotion == "neutrale" and objective.emotional_levels["Rabbia"] >= 3:
        objective.current_emotion = "euforico"
    # FELICITA' LIVELLO 2 + NEUTRALE CON MAX <2 o FELICITA' LIVELLO 1 + 1 CON MAX 1
    elif emotion == "felice" and objective.current_emotion == "neutrale" and objective.emotional_levels["Rabbia"] < 2 or objective.current_emotion == "gioioso" and emotion == "gioioso" and objective.emotional_levels["Rabbia"] < 2:
        objective.current_emotion = "gioioso"
    # FELICITA' LIVELLO 3 + NEUTRALE CON MAX<3 o FELICITA' LIVELLO 2 + 1 CON MAX<3
    elif emotion == "euforico" and objective.current_emotion == "neutrale" and objective.emotional_levels["Rabbia"] < 3 or objective.current_emotion == "felice" and emotion == "gioioso" and objective.emotional_levels["Rabbia"] < 3:
        objective.current_emotion = "felice"
    # FELICITA' LIVELLO 3 CON LIVELLO MASSIMO 1 o FELICITA' LIVELLO 2 + 1 CON LIVELLO MASSIMO 1
    elif emotion == "felice" and objective.current_emotion == "gioioso" and objective.emotional_levels["Rabbia"] < 3:
        objective.current_emotion = "felice"
