...
def change_emotion(objective, emotion):
    ...
    if not objective.is_dead:
        ...
        # TRISTEZZA LIVELLO 2 + NEUTRALE CON MAX <2 o TRISTEZZA LIVELLO 1 + 1 CON MAX 1
            ...
            objective.current_emotion = "triste"
        elif emotion == "depresso" and objective.current_emotion != "triste" and objective.emotional_levels["Tristezza"] < 2:
            objective.current_emotion = "triste"
        ...
        elif emotion == "disperato" and objective.current_emotion == "neutrale" and objective.emotional_levels["Tristezza"] < 3 or objective.current_emotion == "depresso" and emotion == "triste" and objective.emotional_levels["Tristezza"] < 3 or emotion == "disperato" and objective.current_emotion != "triste" and objective.current_emotion != "depresso" and objective.emotional_levels["Tristezza"] < 3:
        ...
        # RABBIA LIVELLO 2 + NEUTRALE CON MAX <2 o RABBIA LIVELLO 1 + 1 CON MAX 1
            ...
            objective.current_emotion = "arrabbiato"
        elif emotion == "iracondo" and objective.current_emotion != "arrabbiato" and objective.emotional_levels["Rabbia"] < 2:
            objective.current_emotion = "arrabbiato"
        elif emotion == "iracondo" and objective.current_emotion == "arrabbiato" and objective.emotional_levels["Rabbia"] == 2:
            objective.current_emotion = "iracondo"
        # Rabbia LIVELLO 3 + NEUTRALE CON MAX<3 o RABBIA LIVELLO 2 + 1 CON MAX<3
        elif emotion == "furioso" and objective.current_emotion == "neutrale" and objective.emotional_levels["Rabbia"] < 3 or objective.current_emotion == "iracondo" and emotion == "arrabbiato" and objective.emotional_levels["Rabbia"] < 3 or emotion == "furioso" and objective.current_emotion != "arrabbiato" and objective.current_emotion != "iracondo" and objective.emotional_levels["Rabbia"] < 3:
            # Per intensità massime controlla i livelli dell'emotional level
            objective.current_emotion = "arrabbiato"
        ...
        # FELICITA' LIVELLO 2 + NEUTRALE CON MAX <2 o FELICITA' LIVELLO 1 + 1 CON MAX 1
            ...
            objective.current_emotion = "gioioso"
        elif emotion == "felice" and objective.current_emotion != "gioioso" and objective.emotional_levels["Felicità"] < 2:
            objective.current_emotion = "gioioso"
        elif emotion == "felice" and objective.current_emotion == "gioioso" and objective.emotional_levels["Felicità"] == 2:
            objective.current_emotion = "felice"
        # FELICITA' LIVELLO 3 + NEUTRALE CON MAX<3 o FELICITA' LIVELLO 2 + 1 CON MAX<3
        elif emotion == "euforico" and objective.current_emotion == "neutrale" and objective.emotional_levels["Felicità"] < 3 or objective.current_emotion == "felice" and emotion == "gioioso" and objective.emotional_levels["Felicità"] < 3 or emotion == "euforico" and objective.current_emotion != "gioioso" and objective.current_emotion != "felice" and objective.emotional_levels["Felicità"] < 3:
            # Per intensità massime controlla i livelli dell'emotional level
            objective.current_emotion = "gioioso"
